...
namespace MySort
{
    public class Probability
    {
        ...
        public Probability()
        {
            ...
            _prizeList.Add(0, new Prize { Name = "平板电脑", Probability = 1 });
            _prizeList.Add(1, new Prize { Name = "数码相机", Probability = 5 });
            _prizeList.Add(2, new Prize { Name = "音箱设备", Probability = 10 });
            _prizeList.Add(3, new Prize { Name = "4G优盘", Probability = 12 });
            _prizeList.Add(4, new Prize { Name = "10Q币", Probability = 22 });
            _prizeList.Add(5, new Prize { Name = "下次没准就能中哦", Probability = 50 });
        }
